--- Based on a copy of /etc/xdg/awesome/rc.lua
...
beautiful.init("/home/m4e5tr0/1-linux/themes/zenburn-by-m4e5tr0.awesome.lua")
...
tags = {
   settings = {
      { names  = { "1:sys", "2:dev", "3:web", "4:doc", "5", "6", "7", "8", "9:FS" },
        layout = { layouts[4], layouts[2], layouts[10], 
                   layouts[10], layouts[1], layouts[1],
                   layouts[1], layouts[1], layouts[11] }
      },
      { names  = { "1:sys", "2:dev", "3:web", "4:doc", "5", "6", "7", "8", "9:FS" },
        layout = { layouts[4], layouts[2], layouts[10], 
                   layouts[10], layouts[1], layouts[1],
